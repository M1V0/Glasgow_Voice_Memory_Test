...
function sound_testRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of sound_testComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function voice_memorisationRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of voice_memorisationComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function voice_task_introRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of voice_task_introComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function voice_task_loadRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of voice_task_loadComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function voice_taskRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of voice_taskComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function voice_feedbackRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of voice_feedbackComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function bells_memorisationRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of bells_memorisationComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function bells_task_introRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of bells_task_introComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function bells_task_loadRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of bells_task_loadComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function bells_taskRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of bells_taskComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function bells_feedbackRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of bells_feedbackComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
